...
public class PizzaMain extends Activity implements OnClickListener,
	...
	private static final String TAG = "PizzaApp";
	...
	/*
	 * RedLaser related fields
	 */
	private static final int REQUEST_REDLASER_SCAN = 3;
	private String udid;
	...
	private String qrcode1 = "Coupon:1234";
	private String qrcode2 = "Coupon:5678";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		udid = RedLaserSettings.getDeviceID(getContentResolver());
	...
	public void onActivityResult(int requestCode, int resultCode, Intent intent) {
		...
		} else if(requestCode == REQUEST_REDLASER_SCAN) {
			if(resultCode == RESULT_OK){
				String barcode = intent.getAction();
				String barcodeType = intent.getStringExtra(BarcodeResult.BARCODE_TYPE);
				Log.d("PizzaMain","BARCODE: "+barcode);
				
				new AlertDialog.Builder(this)
				.setTitle("Scan Result")
				.setMessage(barcodeType+": "+barcode)
				...
				// set up pizza details and load order finalize page
				if(barcode.equals(qrcode1)){
					_size = SIZE_LARGE;
					_number = 2;
					_cheese = true;
					_pepperoni = false;
					_mushrooms = true;
					_onions = true;
				} else if(barcode.equals(qrcode2)) {
					_size = SIZE_MEDIUM;
					_number = 1;
					_cheese = false;
					_pepperoni = true;
				...
				Log.d("PizzaMain","BARCODE SCAN FAILED");
	...
	public void onClick(View arg0) {
		if (arg0 == (Button) findViewById(R.id.Buy)) {
			...
			loadCustomizePage();
		} else if (arg0 == (Button) findViewById(R.id.ScanButton)) {
			launchScanner();			
	...
	public void onDismiss(DialogInterface arg0) {
		if(findViewById(R.id.Continue) != null)
...
//	 This method must be called from the application's onActivityResult() handler
    ...
    public void launchScanner(){
		try{
			...
			Intent scanIntent = new Intent(PizzaMain.this,RedLaserSDK.class);
			scanIntent.putExtras(bundle);
			startActivityForResult(scanIntent, REQUEST_REDLASER_SCAN);
		}catch(Exception e){
			Log.d("PizzaMain",e.getLocalizedMessage()+" "+e.getCause());
		}
	}
