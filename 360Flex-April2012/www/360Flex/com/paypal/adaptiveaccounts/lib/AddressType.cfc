		...
		<cfscript>
		component name="AddressType" output="false"  hint="I define the properties and methods"
		{
			...
			property name="city"  type="string" display="city" required="no" hint="";
			...
			public AddressType function init( string line1="", string countryCode="")
