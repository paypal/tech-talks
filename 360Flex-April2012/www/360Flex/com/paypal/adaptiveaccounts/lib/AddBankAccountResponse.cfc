		...
		<cfscript>
		component name="AddBankAccountResponse" output="false"  hint="I define the properties and methods"
		{
			...
			public AddBankAccountResponse function init( ResponseEnvelope responseEnvelope="", string execStatus="")
