		...
		<cfscript>
		component name="SetFundingSourceConfirmedResponse" output="false"  hint="I define the properties and methods"
		{
			...
			public SetFundingSourceConfirmedResponse function init( ResponseEnvelope responseEnvelope="")
