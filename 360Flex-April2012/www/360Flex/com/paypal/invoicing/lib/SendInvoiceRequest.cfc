		...
		<cfscript>
		component name="SendInvoiceRequest" output="false"  hint="I define the properties and methods"
		{
			...
			public SendInvoiceRequest function init( RequestEnvelope requestEnvelope="", string invoiceID="")
