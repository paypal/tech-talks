		...
		<cfscript>
		component name="CreateInvoiceResponse" output="false"  hint="I define the properties and methods"
		{
			...
			public CreateInvoiceResponse function init( ResponseEnvelope responseEnvelope="", string invoiceID="", string invoiceNumber="", string invoiceURL="", numeric totalAmount="")
