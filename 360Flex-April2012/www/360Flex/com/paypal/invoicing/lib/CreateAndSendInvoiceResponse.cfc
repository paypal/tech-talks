		...
		<cfscript>
		component name="CreateAndSendInvoiceResponse" output="false"  hint="I define the properties and methods"
		{
			...
			public CreateAndSendInvoiceResponse function init( ResponseEnvelope responseEnvelope="", string invoiceID="", string invoiceNumber="", string invoiceURL="", numeric totalAmount="")
