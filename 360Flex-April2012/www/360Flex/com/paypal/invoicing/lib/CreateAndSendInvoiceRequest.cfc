		...
		<cfscript>
		component name="CreateAndSendInvoiceRequest" output="false"  hint="I define the properties and methods"
		{
			...
			public CreateAndSendInvoiceRequest function init( RequestEnvelope requestEnvelope="", InvoiceType invoice="")
