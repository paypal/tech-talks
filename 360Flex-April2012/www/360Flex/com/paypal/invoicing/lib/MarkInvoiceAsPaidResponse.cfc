		...
		<cfscript>
		component name="MarkInvoiceAsPaidResponse" output="false"  hint="I define the properties and methods"
		{
			...
			public MarkInvoiceAsPaidResponse function init( ResponseEnvelope responseEnvelope="", string invoiceID="", string invoiceNumber="", string invoiceURL="")
