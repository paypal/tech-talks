		...
		<cfscript>
		component name="SendInvoiceResponse" output="false"  hint="I define the properties and methods"
		{
			...
			public SendInvoiceResponse function init( ResponseEnvelope responseEnvelope="", string invoiceID="", string invoiceURL="")
