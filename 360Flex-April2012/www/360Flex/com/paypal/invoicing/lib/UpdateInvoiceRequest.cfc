		...
		<cfscript>
		component name="UpdateInvoiceRequest" output="false"  hint="I define the properties and methods"
		{
			...
			public UpdateInvoiceRequest function init( RequestEnvelope requestEnvelope="", string invoiceID="", InvoiceType invoice="")
