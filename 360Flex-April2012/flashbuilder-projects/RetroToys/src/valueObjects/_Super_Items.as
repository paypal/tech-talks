...
public class _Super_Items extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
     ...
     * properties
     */
    private var _internal_item : valueObjects.Item;
    ...
    public function get item() : valueObjects.Item
    {
    ...
    public function set item(value:valueObjects.Item) : void
    {
        var oldValue:valueObjects.Item = _internal_item;
        if (oldValue !== value)
        {
    ...
    model_internal var _doValidationLastValOfItem : valueObjects.Item;

    model_internal function _doValidationForItem(valueIn:Object):Array
    {
        var value : valueObjects.Item = valueIn as valueObjects.Item;
